...
export type ReferenceType = {url?:string, role?:RoleEnum, title?:string, fragments?:Fragment[], abstract?:InlineContentElement[]} &
 (DocCOMAppleSwiftUIDocumentationSwiftUIAccessibilityRotorContentClass |DocCOM | DocCOMApple | 
DocCOMAppleSwiftUIDocumentationSwiftUI | SwiftUIForEachFontsPNG);
