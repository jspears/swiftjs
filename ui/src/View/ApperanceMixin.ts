...
import type { AlignmentKey, EdgeKey, VerticalEdge, VirticalEdgeSetKey } from '../Edge';
import { Shape } from '../Shape';
import { Dot, fromEnum, fromKey, KeyOf, KeyOfTypeWithType, Num } from '@tswift/util';
...
export class ApperanceMixin<S extends ShapeStyle = ShapeStyle> {
  ...
  color(c?: ColorKey | undefined): this {
    this._color = typeof c === 'string' ? Color[c.slice(1) as keyof typeof Color] : c;  
    return this;
  }

  accentColor(c?: ColorKey): this {
    this._accentColor = typeof c === 'string' ? Color[c.slice(1) as keyof typeof Color] : c;  
    return this;
  }
  ...
  foregroundColor(c?: ColorKey): this {
    this._foregroundColor = typeof c === 'string' ? Color[c.slice(1) as keyof typeof Color] : c;  
    return this;
  }
