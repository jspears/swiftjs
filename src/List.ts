...
export type ListConfig<T> = (HasSelection<T> & HasContent) | HasContent | HasSelection<T>;
...
export const List = Object.assign((<T>(...args:ConstructorParameters<typeof ListClass<T>>)=>new ListClass<T>(...args)), ListClass) ;
